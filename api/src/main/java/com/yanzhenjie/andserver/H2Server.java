...
import com.yanzhenjie.andserver.delegate.H2StreamListener;
...
import com.yanzhenjie.andserver.http2.HttpVersionPolicy;
...
public interface H2Server extends Server {
    ...
    interface Builder<T extends Builder<T, S>, S extends H2Server> extends Server.Builder<T, S, ServerListener> {
        /**
         ...
         */
        T setVersionPolicy(HttpVersionPolicy versionPolicy);

        /**
         * Assigns {@link H2ConfigDelegate} instance.
         */
        T setH2Config(H2ConfigDelegate h2Config);
         ...
         * Will be called after server class defined listener.
         */
        T setStreamListener(H2StreamListener streamListener);
    }

    interface ProxyBuilder<T extends ProxyBuilder<T, S>, S extends H2Server>
