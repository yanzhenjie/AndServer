...
public class BasicClientTlsStrategy implements TlsStrategy {
    ...
    public org.apache.hc.core5.http.nio.ssl.TlsStrategy wrapped() {
        return new org.apache.hc.core5.http.nio.ssl.BasicClientTlsStrategy(sslContext);
    }
    ...
    public BasicClientTlsStrategy() throws NoSuchAlgorithmException, KeyManagementException {
