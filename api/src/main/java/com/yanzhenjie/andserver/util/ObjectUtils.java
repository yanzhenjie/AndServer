...
/**
 * Created by YanZhenjie on 2018/7/5.
 */
public abstract class ObjectUtils {
    ...
    /**
     * Determine whether the given object is empty. <p>This method supports the following object types. <ul> <li>{@code
     * Array}: considered empty if its length is zero</li> <li>{@link CharSequence}: considered empty if its length is
     * zero</li> <li>{@link Collection}: delegates to {@link Collection#isEmpty()}</li> <li>{@link Map}: delegates to
     * {@link Map#isEmpty()}</li> </ul> <p>If the given object is non-null and not one of the aforementioned supported
     ...
     *
     * @param array the array to check (may be {@code null}, in which case the return value will always be {@code
     *     false}).
    ...
    public static <E extends Enum<?>> E caseInsensitiveValueOf(E[] enumValues, String constant) {
        ...
        String message = String.format("constant [%s] does not exist in enum type %s", constant,
     ...
     * objects). <p>A {@code null} source value will be converted to an empty Object array.
     *
     ...
     * only one is {@code null}. <p>Compares arrays with {@code Arrays.equals}, performing an equality check based on
     ...
     *
     * <p>Builds a String representation of the contents in case of an array. Returns {@code "null"} if {@code obj} is
     * {@code null}.
     *
