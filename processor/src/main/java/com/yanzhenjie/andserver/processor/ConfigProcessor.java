...
public class ConfigProcessor extends BaseProcessor {
    ...
    public synchronized void init(ProcessingEnvironment processingEnv) {
        ...
        mConfig = TypeName.get(elements.getTypeElement(Constants.CONFIG_TYPE).asType());
        mDelegate = TypeName.get(elements.getTypeElement(Constants.CONFIG_DELEGATE_TYPE).asType());
        mWebsite = TypeName.get(elements.getTypeElement(Constants.WEBSITE_TYPE).asType());
        mMultipart = TypeName.get(elements.getTypeElement(Constants.CONFIG_MULTIPART_TYPE).asType());
