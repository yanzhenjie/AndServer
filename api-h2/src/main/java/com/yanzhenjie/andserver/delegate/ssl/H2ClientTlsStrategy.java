...
public class H2ClientTlsStrategy implements TlsStrategy {
    ...
    public org.apache.hc.core5.http.nio.ssl.TlsStrategy wrapped() {
        return new org.apache.hc.core5.http2.ssl.H2ClientTlsStrategy(sslContext);
    }
    ...
    public H2ClientTlsStrategy() throws NoSuchAlgorithmException, KeyManagementException {
